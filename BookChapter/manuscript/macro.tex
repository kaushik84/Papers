...
\makeatletter
\if@twocolumn
	\newcommand{\figscalet}{0.8 \columnwidth}
	\newcommand{\figscalett}{\columnwidth}
	\newcommand{\figscale}{0.65 \columnwidth}
\else
	\newcommand{\figscale}{0.7\columnwidth}
	\newcommand{\figscalet}{0.65 \columnwidth}
	\newcommand{\figscalett}{0.8 \columnwidth}
	\newcommand{\figfscale}{\columnwidth}
	\newcommand{\resizescale}{0.7 \textwidth}
\fi
\makeatother
...
\DeclareMathOperator*{\tst}{\text{T}(\textbf{y})}
...
\renewcommand*{\theoremname}{Problem}
\newtheorem{approxi}{Approximation}[section]
