...
if 1
    ...
    figure(1);
    h1 = plot(N_est_th(pts) * 1e-3, P_d_id_th(1,pts),'c-', 'LineWidth', 2);
    hold on, 
    h2  = plot(N_est_th(pts) * 1e-3, P_d_ac_th(1,pts),'-', 'LineWidth', 1);
    hold on,
    h3 = plot(N_est_th(pts) * 1e-3, P_d_oc_th(1,pts),'--', 'LineWidth', 1);
    ...
    if 1
        ...
        hold on,
        plot(N_est_th(pts) * 1e-3, P_d_oc_th(1,pts),'--', 'LineWidth', 1);
    end
    ...
    if 1
        hold on,
        h4 = plot(N_est_sim(scale) * 1e-3, P_d_ac_sim(1,scale),'kx', 'LineWidth', 1);         
    end
    hold on,
    plot(N_est_sim(scale) * 1e-3, P_d_oc_sim(1,(scale)),'kx', 'LineWidth', 1);  
...
if 1
    ...
    h1 = semilogy(N_est_th(pts1) * 1e-3, P_f_id_th(1,pts1),'c-', 'LineWidth', 2);
    hold on,
    h2 = semilogy(N_est_th(pts2) * 1e-3, P_f_ac_th(1,pts2),'-', 'LineWidth', 1);
    hold on,
    h3 = semilogy(N_est_th(pts1) * 1e-3, P_f_oc_th(1,pts1),'--', 'LineWidth', 1);    
    ...
    if 1
        ...
        hold on,
        semilogy(N_est_th(pts1) * 1e-3, P_f_oc_th(1,pts1),'--', 'LineWidth', 1);           
    end
    ...
    if 1
        hold on,
        h4 = semilogy(N_est_sim(scale) * 1e-3, P_f_ac_sim(1,scale),'kx', 'LineWidth', 1);         
    end
    hold on,
    h5 = semilogy(N_est_sim(scale) * 1e-3, P_f_oc_sim(1,(scale)),'kx', 'LineWidth', 1);  
    ...
    if 1
        ...
        hold on,
        semilogy(N_est_sim(scale) * 1e-3, P_f_oc_sim(1,(scale)),'kx', 'LineWidth', 1);  
    end
