...
hold on,
h2 = plot(N_sen_th(index) * 1e-3, R_ac_th(index),'LineStyle', '-', 'LineWidth', 1);
hold on,
h3 = plot(N_sen_th(index) * 1e-3, R_oc_th(index), 'LineStyle', '--', 'LineWidth', 1);
...
if 1
    ...
    hold on,
    h4 = plot(N_sen_sim * 1e-3, R_id_sim, 'kx', 'LineWidth',1);
    hold on,
    plot(N_sen_sim * 1e-3, R_ac_sim, 'kx', 'LineWidth',1, 'HandleVisibility','off');
    hold on,
    plot(N_sen_sim * 1e-3, R_oc_sim, 'kx', 'LineWidth',1, 'HandleVisibility','off');
end 
hold on,
...
if 1
    ...
    plot(N_sen_th(indexOfInterest) * 1e-3, R_id_th(indexOfInterest), 'c', 'LineWidth',2);
    hold on,
