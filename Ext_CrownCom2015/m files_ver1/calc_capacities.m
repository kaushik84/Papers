...
function[C_0, C_1] = calc_capacities(snr_p2, snr_s, noise_power)
    ...
    K = 1000;                               % Number of samples used for energy detection for the signal at 
    ...
    %% Evaluate C_1
    func_exp_C0 = @(t) t .* 2.^(t) * log(2) .* 1/b_gamma_s^(a_gamma_s)...
