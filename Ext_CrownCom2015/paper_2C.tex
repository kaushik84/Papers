...
\begin{IEEEbiography}
[{\includegraphics[width=1.0in,height=1.25 in,clip,keepaspectratio]{jondral.eps}}]{\textbf{Friedrich K. Jondral (SM'94)}} K. Jondral received a diploma in mathematics (Dipl.-Math.) and a doctoral degree in natural sciences (Dr.rer.nat.) from the Technische Universität Braunschweig (Germany) in 1975 and 1979, respectively. During the winter semester 1977/78 he was a visiting scientist to Professor Takeyuki Hida, Ph.D., at the Department of Mathematics of Nagoya University, Nagoya (Japan). \\
