...
if th
    ...
    for e = 1:length(epsilon_P)
        parfor s = 1:length(alpha_true_p)    
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            nc_th = (10^(noise_power_p/10)/10^(-alpha_true_p(s)/10) + 10^(P_tran/10));
            disp(strcat('SNR = ',num2str(P_tran - noise_power_p - alpha_true_p(s)))); 
    ...
    save('results_opt_thr_vs_snr_AWGN_nu_lower_th_CR.mat');
    quit;
end
