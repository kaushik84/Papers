...
if simulation == 1
    ...
    save('results_PPP_CR_TransmitPowerVs_CR_lambda_1e3.mat');
    quit;
end

load('results_PPP_CR_TransmitPowerVs_CR_lambda_1e3.mat')
...
print(gcf,'-dpdf','../figures/fig_CR_Txp_vs_lambda_CR_1e3');
print(gcf,'-depsc','../figures/fig_CR_Txp_vs_lambda_CR_1e3');
