...
if simulation == 1
    ...
    save('results_PPP_CR_TransmitPowerVs_CR_lambda_wkr_1e5.mat');
    quit;
end

load('results_PPP_CR_TransmitPowerVs_CR_lambda_wkr_1e5.mat')
...
print(gcf,'-dpdf','../figures/fig_CR_Txp_vs_lambda_CR_wkr_1e5');
print(gcf,'-depsc','../figures/fig_CR_Txp_vs_lambda_CR_wkr_1e5');
