...
if simulation == 1
    ...
    save('results_PPP_Cap_Out_ID_1e3.mat');
    quit;
end

load('results_PPP_Cap_Out_ID_1e3.mat')
...
print(gcf,'-dpdf','../figures/fig_ID_Cap_Out_vs_epsilon_1e3');
print(gcf,'-depsc','../figures/fig_ID_Cap_Out_vs_epsilon_1e3');
