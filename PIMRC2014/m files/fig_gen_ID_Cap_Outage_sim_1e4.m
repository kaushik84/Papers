...
if simulation == 1
    ...
    Cap_Out_sim = zeros(length(alpha), length(d_s), sim_len);
    Cap_Out_th = zeros(length(alpha), length(d_s), sim_len);
    ...
    save('results_PPP_Cap_Out_ID_1e4.mat');
    quit;
end

load('results_PPP_Cap_Out_ID_1e4.mat')
...
print(gcf,'-dpdf','../figures/fig_ID_Cap_Out_vs_epsilon_1e4');
print(gcf,'-depsc','../figures/fig_ID_Cap_Out_vs_epsilon_1e4');
