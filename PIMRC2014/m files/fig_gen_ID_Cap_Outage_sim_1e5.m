...
if simulation == 1
    ...
    save('results_PPP_Cap_Out_ID_1e5.mat');
    quit;
end

load('results_PPP_Cap_Out_ID_1e5.mat')
...
print(gcf,'-dpdf','../figures/fig_ID_Cap_Out_vs_epsilon_1e5');
print(gcf,'-depsc','../figures/fig_ID_Cap_Out_vs_epsilon_1e5');
