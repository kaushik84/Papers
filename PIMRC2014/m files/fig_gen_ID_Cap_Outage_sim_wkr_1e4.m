...
if simulation == 1
    ...
    save('results_PPP_Cap_Out_ID_wkr_1e4.mat');
    quit;
end

load('results_PPP_Cap_Out_ID_wkr_1e4.mat')
...
hl = legend(strcat('the $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(2))),...
    ...
    strcat('sim $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(1))),...
    strcat('the $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(1))),...
    strcat('sim $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(3))),...
    strcat('sim $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(3))),...
    strcat('the $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(4))),...
    strcat('sim $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(4))),...
    'Location','NorthEast');
...
print(gcf,'-dpdf','../figures/fig_ID_Cap_Out_vs_epsilon_wkr_1e4');
print(gcf,'-depsc','../figures/fig_ID_Cap_Out_vs_epsilon_wkr_1e4');
