...
if simulation == 1
    ...
    save('results_PPP_Cap_Out_ID_wkr_1e5.mat');
    quit;
end

load('results_PPP_Cap_Out_ID_wkr_1e5.mat')

theta_th = (0.0001:0.0001:.999);
...
hl = legend(strcat('theory $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(2))),...
    strcat('simul. $d_s$ = ', num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(2))),... 
    strcat('theory $d_s$ = ',num2str(d_s(2)),', $\alpha$ = ',num2str(alpha(2))),...
    strcat('simul. $d_s$ = ',num2str(d_s(2)),', $\alpha$ = ',num2str(alpha(2))),...
    strcat('theory $d_s$ = ',num2str(d_s(3)),', $\alpha$ = ',num2str(alpha(2))),...
    strcat('simul. $d_s$ = ',num2str(d_s(3)),', $\alpha$ = ',num2str(alpha(2))),...
    strcat('theory $d_s$ = ',num2str(d_s(4)),', $\alpha$ = ',num2str(alpha(2))),... 
    strcat('simul.    $d_s$ = ',num2str(d_s(4)),', $\alpha$ = ',num2str(alpha(2))),...
    strcat('theory $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(1))),...
    strcat('simul.   $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(1))),...
    strcat('theory $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(3))),...
    strcat('simul.    $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(3))),...
    strcat('theory $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(4))),...
    strcat('simul.    $d_s$ = ',num2str(d_s(1)),', $\alpha$ = ',num2str(alpha(4))),...
    'Location','NorthEast');
...
print(gcf,'-dpdf','../figures/fig_ID_Cap_Out_vs_epsilon_wkr_1e5');
print(gcf,'-depsc','../figures/fig_ID_Cap_Out_vs_epsilon_wkr_1e5');
